            ...
            for column in range(len(eggArray[row])):
                ...
                if (eggArray[row][column] != self.setting.blank and self.newEgg != None): #nếu trứng khác rỗng
                    ...
                    if (pygame.sprite.collide_rect(self.newEgg, eggArray[row][column])) or self.newEgg.rect.top <= 0:
                        ...
                        # nếu trứng chạm vào các quả trứng khác nếu bên cạnh còn trống thì gán vị trí đó bằng trứng mới
...
class Engine:
    ...
    def __init__(self):    
        ...
        self.main_font = pygame.font.SysFont('Helvetica', self.setting.text_height)                
        pygame.display.set_caption('Ban trung khung long')        
        self.musicList = ['assets/sounds/game_music.ogg', 'assets/sounds/giorno_theme.ogg', 'assets/sounds/Goofy_Theme.ogg']
        self.running = True
        self.game = None
    ...
    def restart_game(self):        
        self.menu.is_open = False        
        self.game = Dino(self, self.screen)        
